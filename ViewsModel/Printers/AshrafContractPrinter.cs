...
{
    public class AshrafContractPrinter
    {
        ...
        public AshrafContractPrinter(string templatePath, [NotNull] ContractDto contract, [NotNull] Func<string, string> extractPropertyNo, [NotNull] Func<string, string, string> extractLocation)
        {
